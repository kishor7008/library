...
export default function Wallet() {
    return (
        <>
            ...
            <div class="container1" style={{ width: "100%", marginTop: "100px" }} >
                <div class="iphone" style={{ width: "70%" }}>
                    <div class="header1">
                        ...
                        <div class="card">
                            <div class="upper-row">
                                <div class="card-item">
                                    ...
                                    <span>1&nbsp;804</span> <span class="dollar">&#8377;</span>
                                </div>
                                <div class="card-item">
                                    <span>My Save it</span>
                                    <span>2&nbsp;000</span> <span class="dollar">&#8377;</span>
                                </div>
                            </div>
                            <div class="lower-row">
                                <div class="icon-item">
